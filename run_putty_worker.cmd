...
set SSH_KEY=%THIS_BATCH_PATH%\.vagrant\machines\K8s-Worker1\virtualbox\private_key
...
if exist !SSH_KEY_PUTTY! (
    ...
    !KITTY! -ssh -l !SSH_USERNAME! -pw !AUTO_PASSWORD! -i !SSH_KEY_PUTTY! -P !HOST_PORT! -X !HOST_IP!
) else (
...
set /p vm_id=<.vagrant\machines\K8s-Worker1\virtualbox\id
